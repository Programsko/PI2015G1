...
namespace Vj4G1
{
    class Loto
    {
        ...
        /// <summary>
        /// Dodaje korisničke vrijednosti u listu uplaćenih brojeva. 
        /// Svaka vrijednost se prethodno provjerava i uzima u obzir 
        /// samo ukoliko se radio o cjelobrojnoj vrijednosti u raspnu 
        /// od 1 do 39, i ako već ne postoji ista vrijednost u listi.
        /// </summary>
        /// <param name="korisnickeVrijednosti">Vrijednosti koje je unio korisnik.</param>
        /// <returns>True ako se u listgi nalazi 7 jedinstvenih brojeva u rasponu od 1 do 39, 
        /// u suprotnom False.</returns>
        ...
        /// <summary>
        /// Generira 7 nasumičnih jedinstvenih cijelih brojeva u rasponu 
        /// od 1 do 39, te ih sprema u listu kao dobitnu kombinaciju brojeva.
        /// </summary>
